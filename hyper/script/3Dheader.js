...
// lightHeader = new THREE.DirectionalLight(0x42c8f5, 0.5)
// lightHeader.position.set(0, 0, 6)
// sceneHeader.add(lightHeader)

// lightHeader2 = new THREE.DirectionalLight(0x93fad1, 0.5)
// lightHeader2.position.set(-6, 0, 0)
// sceneHeader.add(lightHeader2)

lightHeader3 = new THREE.DirectionalLight(0x60f542, 0.5)
lightHeader3.position.set(0, 6, 0)
sceneHeader.add(lightHeader3)

// lightHeader4 = new THREE.DirectionalLight(0xce42f5, 0.5)
// lightHeader4.position.set(0, -6, 0)
// sceneHeader.add(lightHeader4)
...
uniforms = {
                "time": { value: 1.0 },
                "colorTexture": { value: new THREE.TextureLoader().load( '../../../media/Seamless.png' ) }
            };
